	...
	<div class="col-sm-10 col-sm-offset-2 col-md-11 col-md-offset-1 main">
		...
		<div class="row main">
			<div class="alert alert-success">
				Zarejestrowano pomyślnie warsztat:
				<%
				...
				<%
					...
					response.addHeader("Refresh", "5; http://localhost:8080/ISI_2017_ASO/PanelAdmina/warsztatyAdmin.jsp");
				%>
			</div>
			<button type="button" id="Kontynuuj"
				class="button col-sm-2 col-sm-offset-8 col-md-2 col-md-offset-9">
				<a href="/ISI_2017_ASO/PanelAdmina/warsztatyAdmin.jsp">Kontynuuj</a>
			</button>
		</div>
