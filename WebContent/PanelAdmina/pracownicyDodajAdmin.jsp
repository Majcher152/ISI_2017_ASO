...
<div class="container marketing">
	...
	<div class="col-sm-10 col-sm-offset-2 col-md-11 col-md-offset-1 main">
		...
		<div class="main-login main-center">
			...
			<div class="form-group">
				<label for="rodzaj" class="cols-sm-2 control-label">Rodzaj
					pracownika:</label>
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-users fa"
							aria-hidden="true"></i></span> <select name="rodzaj" id="rodzaj"
				...
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-lock fa-lg"
							...
							class="form-control" name="haslo" id="haslo"
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-lock fa-lg"
							aria-hidden="true"></i></span> <input type="password"
							class="form-control" name="haslo2" id="haslo2"
