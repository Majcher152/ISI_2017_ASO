				...
				<div class="container">
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							<li><a href="indexKlient.jsp">Strona główna</a></li>
							...
							<li class="dropdown"><a href="index.jsp"
								...
								<ul class="dropdown-menu">
									<li><a href="cennikKlient.jsp">Cennik podstawowy</a></li>
									<li><a href="">Cennik rozszerzony</a></li>
								</ul></li>
								<li><a href="">Przegląd</a></li>
								<li><a href="">Historia Serwisowania</a></li>
							<li><a href="oNasKlient.jsp">O nas</a></li>
							<li><a href="kontaktKlient.jsp">Kontakt</a></li>
