	...
	%>
		...
		<script type="text/javascript">
			$( document ).ready(function() {
				...
				$.ajax({
                    type: "POST",
                    url: "KsiegowyMagazynServlet?metoda=zaladujRoczniki",
                    data: {model: $model.val() },
                    success: function(ret){
                        $("#rocznik").html(ret); 
                        $.ajax({
                            type: "POST",
                            url: "KsiegowyMagazynServlet?metoda=zaladujTypy",
                            data: {model: $model.val(), rocznik: $rocznik.val() },
                            success: function(ret){
                                $("#typ").html(ret);   
                                $.ajax({
                                    type: "POST",
                                    url: "KsiegowyMagazynServlet?metoda=zaladujSilniki",
                                    ...
                                    success: function(ret){
                                        ...
                                        $.ajax({
						                    type: "POST",
						                    url: "KsiegowyMagazynServlet?metoda=zaladujCzesci",
		...
		<div class="row main">
							<a href="KsiegowyMagazynServlet?metoda=zaladujZamowienie"><h3><b>Zamówienie</b></h3></a>
							<br/>
