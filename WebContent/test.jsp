		...
		<div class="row featurette">
			<div class="col-md-7 col-md-push-5">
				...
				<p class="lead">Dla potwierdzenia najwyższej jakości oferowanych
					...
					Polskiego Centrum Badań i Certyfikacji w roku 2001, a w roku 2006
					od firmy TUV AUTOMOTIVE.</p>
			</div>
		...
		<div class="row featurette">
			<div class="col-md-7">
				...
				<p class="lead">Dla Państwa bezpieczeństwa oraz wygody
					stworzyliśmy usługę “Assistance 24h”, w skład której, wchodzi
					między innymi całodobowe holowanie samochodów do naszych serwisów.
