...
public class SterownikKsiegowego {
	...
	public int zatwierdzRezerwacjeNaprawy(String id, String dataoddania, String przewid_czas_trwania) {
		...
		if(spbd.zatwierdzRezerwacjeNaprawy(id, dataoddania, przewid_czas_trwania))
			return 0;
		else return -1;
	}
